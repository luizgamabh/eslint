...
const ModuleResolver = require("../../shared/module-resolver");
...
const eslintRecommendedPath = require.resolve("../../../conf/eslint-recommended.js");
const eslintAllPath = require.resolve("../../../conf/eslint-all.js");
