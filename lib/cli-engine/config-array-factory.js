...
/** @typedef {import("../../conf/config-schema").OverrideConfigData} OverrideConfigData */
/** @typedef {import("./config-array/config-dependency").Parser} Parser */
/** @typedef {import("./config-array/config-dependency").Plugin} Plugin */
