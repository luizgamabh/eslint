...
// To access the intarnal slots of Linter to improve performance.
const { getLinterInternalSlots } = require("../linter/linter"); // eslint-disable-line no-restricted-modules
