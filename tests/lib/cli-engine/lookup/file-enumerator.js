...
const { ConfigArrayFactory } = require("../../../../lib/cli-engine/lookup/config-array-factory");
const { ExtractedConfig } = require("../../../../lib/cli-engine/lookup/extracted-config");
const { FileEnumerator } = require("../../../../lib/cli-engine/lookup/file-enumerator");
const { IgnoredPaths } = require("../../../../lib/cli-engine/lookup/ignored-paths");
    ...
    describe("'iterateFiles(patterns)' method should iterate files and configs.", () => {
        ...
        describe(`with the files ${JSON.stringify(files)}`, () => {
            ...
            describe("if 'lib/*.js' was given,", () => {
                ...
                /** @type {Array<{config:(typeof import('../../../../lib/cli-engine/lookup'))["ConfigArray"], filePath:string, ignored:boolean}>} */
                let list;
