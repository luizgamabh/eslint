...
const ConfigArrayFactoryPath =
    require.resolve("../../../../lib/cli-engine/lookup/config-array-factory");
const FileEnumeratorPath =
    require.resolve("../../../../lib/cli-engine/lookup/file-enumerator");
const IgnoredPathsPath =
    require.resolve("../../../../lib/cli-engine/lookup/ignored-paths");
const LoadRulesPath =
    require.resolve("../../../../lib/cli-engine/lookup/load-rules");
const ESLintAllPath =
 ...
 * @returns {{ fs: typeof import("fs"), ConfigArrayFactory: (typeof import("../../../../lib/cli-engine/lookup/config-array-factory"))["ConfigArrayFactory"] }} The stubbed `ConfigArrayFactory` class.
 */
 ...
 * @param {() => string} [options.cwd] The current working directory.
 * @param {Object} [options.files] The initial files definition in the in-memory file system.
 * @returns {{ fs: typeof import("fs"), FileEnumerator: (typeof import("../../../../lib/cli-engine/lookup/file-enumerator"))["FileEnumerator"], ConfigArrayFactory: (typeof import("../../../../lib/cli-engine/lookup/config-array-factory"))["ConfigArrayFactory"], IgnoredPaths: (typeof import("../../../../lib/cli-engine/lookup/ignored-paths"))["IgnoredPaths"] }} The stubbed `FileEnumerator` class.
 */
